...
echo -e "${BLUE}=== Node System Setup Script ===${NC}"
echo -e "${YELLOW}This script will configure your node system with Docker, security settings, and more${NC}"
echo
...
echo
echo -e "${GREEN}=== Node System Setup Complete! ===${NC}"
